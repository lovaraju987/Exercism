...
def add_me_to_the_queue(express_queue, normal_queue, ticket_type, person_name):
    ...
    return (
        # express_queue + [person_name] if ticket_type == 1
        # else normal_queue + [person_name]
        [*express_queue, person_name] if ticket_type == 1
        else [*normal_queue, person_name]
    )
print(add_me_to_the_queue(express_queue=['tony','bruce'],normal_queue=['robbotguy','ww'],ticket_type=1,person_name='raju'))
...
# print(find_my_friend(['cat', 'dog', 'rabbit', 'horse'],'dog'))
